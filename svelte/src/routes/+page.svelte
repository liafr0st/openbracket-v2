...
<div class="flex flex-row max-w-xl md:mx-auto mt-72 my-3.5 items-center justify-center">
    <a 
        class="btn text-4xl leading-[52px] text-ob-gray text-center align-middle bg-white border-4 border-white hover:bg-opacity-90 h-18 w-480px px-4 py-2 mx-12 rounded-full" href="/create">
        Create Tournament
    </a>
</div>
